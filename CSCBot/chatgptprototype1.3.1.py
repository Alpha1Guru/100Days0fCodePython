...
ADMIN_USER_ID = 6841347676  # Replace with your actual Telegram numeric ID
...
def main():
    ...
    if not bot_token:
        raise ValueError("BOT_TOKEN environment variable is missing. Set it before running the bot.")
